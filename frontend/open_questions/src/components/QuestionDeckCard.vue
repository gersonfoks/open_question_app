...
export default {
    ...
    methods: {
        deleteDeck() {
            this.$emit('deleteDeck', this.questionDeck.name)
        }
    }
}
...
<template>
    ...
    <div class="card">
          ...
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title">{{questionDeck.name}}</h5>
            <button type="button" class="btn btn-outline-secondary" @click="deleteDeck">
        ...
        <div class="card-body">
            ...
            <p class="card-text">{{questionDeck.description}}</p>
